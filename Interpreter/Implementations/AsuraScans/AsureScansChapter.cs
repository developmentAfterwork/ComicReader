...
namespace ComicReader.Interpreter.Implementations.AsuraScans
{
	...
	{
		public AsureScansChapter(string? id, string source, string mangaName, string title, string homeUrl, string lastUpdate, TimeSpan timeout, IRequest requestHelper, HtmlHelper htmlHelper, INotification notification) : base(id, title, homeUrl, lastUpdate, mangaName, source, timeout, requestHelper, htmlHelper, null) { }
